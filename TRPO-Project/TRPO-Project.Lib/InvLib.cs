namespace TRPO_Project.Lib
{
    public class InvLib
    {
        public double ProfitExpected(double CurrentAvgPrice, double PurchaseAvgPrice, double CurrentAmount)
        {
        ...
        public double ProfitFixed(double SaleSum, double PurchaseAvgPrice, double SoldAmount, double DividendsSum, double CouponsSum)
        {
        ...
        public double Income(double ProfitExpected, double ProfitFixed, double PurchaseAvgPrice, double CurrentAmount, double SaleSum)
        {
